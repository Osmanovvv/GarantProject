			...
			<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
				...
				<div className="relative z-10 text-center text-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
					...
					<p className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 text-gray-200 max-w-4xl mx-auto leading-relaxed px-2 xs:px-4">
						Доставим быстро, точно и по доступным ценам по Крыму и за его пределами.
						Специализируемся на перевозке стройматериалов, окон и т.д.
					</p>
					...
					<div className="mt-6 sm:mt-8 inline-block bg-garant-gold text-garant-navy px-3 xs:px-4 py-2 sm:px-6 sm:py-3 rounded-full font-semibold shadow-lg text-xs xs:text-sm sm:text-base mx-2 xs:mx-0">
						<span className="hidden xs:inline">
							🎉 Скидка 10% для новых клиентов из интернета!
						</span>
						<span className="xs:hidden">🎉 Скидка 10% если с сайта!</span>
					</div>
				</div>
					...
					<div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
						<div className="order-2 lg:order-1">
							...
							<p className="text-base sm:text-lg text-gray-700 mb-6 sm:mb-8 leading-relaxed">
								Мы предоставляем качественные <strong>услуги грузоперевозок</strong> по всему Крыму и за его пределами — работаем в <strong>Симферополе, Ялте, Севастополе, Керчи, Евпатории, Феодосии</strong> и других городах.
								Наша компания гарантирует надежную доставку ваших грузов в кратчайшие сроки.
								Специализируемся на <strong>перевозке строительных материалов , окон и и других грузов.</strong>
							</p>
						...
						<div className="order-1 lg:order-2">
							<div className="bg-garant-navy rounded-lg p-6 sm:p-8 text-white">
								...
								<p className="text-gray-300 text-sm sm:text-base">
									Все наши автомобили находятся в отличном техническом
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12 sm:mb-16">
						...
						<p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
							Надежный партнер в сфере грузоперевозок
						</p>
					</div>
						...
						<div>							
							<div className="space-y-4 sm:space-y-6">
								<div className="flex items-start gap-3 sm:gap-4">
									...
									<div>
										...
										<p className="text-gray-600 text-sm sm:text-base">
											Многолетний опыт в сфере <strong>грузоперевозок по Крыму</strong> позволяет нам быстро и безопасно доставлять стройматериалы и крупногабаритные грузы. Работаем по всему Крыму и за его пределами.
										</p>
									</div>
								</div>
								...
								<div className="flex items-start gap-3 sm:gap-4">
									...
									<div>
										<h4 className="text-lg sm:text-xl font-semibold text-garant-navy mb-2">
											Собственный автопарк: Газели 3–6 м, манипуляторы
										</h4>
										<p className="text-gray-600 text-sm sm:text-base">
											В нашем распоряжении — <strong>Газели от 3 до 6 метров</strong>, машины грузоподъёмностью до 5 тонн, а также <strong>манипуляторы</strong>. Весь транспорт принадлежит компании, что гарантирует контроль качества и сроков доставки.
										</p>
									</div>
								</div>
								...
								<div className="flex items-start gap-3 sm:gap-4">
									...
									<div>
										...
										<p className="text-gray-600 text-sm sm:text-base">
											Обслуживаем <strong>частных клиентов и строительные компании</strong>. Предоставляем все необходимые документы, работаем с НДС, без посредников. Оплата наличными или по безналу.
										</p>
									</div>
								</div>
							</div>
						...
						<div className="grid grid-cols-2 gap-4 sm:gap-6">
							<Card className="text-center p-4 sm:p-6 border-garant-gold border-2">
								<CardContent className="p-0">
									<div className="text-2xl sm:text-3xl font-bold text-garant-gold mb-2 drop-shadow-sm">
										#1
									</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12 sm:mb-16">
						...
						<p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
							Специализированные грузоперевозки строительных материалов и крупногабаритных грузов по Крыму и за его пределами — Симферополь, Севастополь, Ялта, Евпатория, Керчь и другие города.
						</p>
					</div>
					...
					<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
						...
						<Card className="text-center p-6 sm:p-8 hover:shadow-lg transition-shadow border-2 hover:border-garant-gold">
							<CardContent className="p-0">
								...
								<p className="text-gray-600 text-sm sm:text-base">
									Специальные рамы и крепления обеспечивают надежную транспортировку хрупких грузов без повреждений.
								</p>
							</CardContent>
						</Card>
						...
						<Card className="text-center p-6 sm:p-8 hover:shadow-lg transition-shadow border-2 hover:border-garant-gold sm:col-span-2 lg:col-span-1">
							<CardContent className="p-0">
								...
								<h4 className="text-lg sm:text-xl lg:text-2xl font-semibold text-garant-navy mb-3 sm:mb-4">
									Доставка по Крыму и за его пределами
								</h4>
								<p className="text-gray-600 text-sm sm:text-base">
									Комплексные решения для перевозки любых грузов — от частных заказов до крупных строительных проектов по всему полуострову и регионам.
								</p>
							</CardContent>
						</Card>
					</div>
								...
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-gray-600 text-sm">
											Рамы и крепления для безопасной фиксации стекла и стройматериалов.
										</p>
									</div>
								</div>
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-gray-600 text-sm">
											Знают все дороги Крыма и обеспечивают аккуратную погрузку.
										</p>
									</div>
								</div>
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-gray-600 text-sm">
											Полная материальная ответственность за сохранность вашего груза.
										</p>
									</div>
								</div>
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-gray-600 text-sm">
											Возможна почасовая оплата или фиксированная стоимость.
										</p>
									</div>
								</div>
							</div>
					...
					<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
						...
						<Card className="p-4 sm:p-6">
							<CardContent className="p-0">
								...
								<p className="text-gray-600 mb-4 text-sm sm:text-base">
									"Сотрудничаем уже несколько лет. Постоянно пользуемся услугами манипулятора. Надежные партнеры, всегда
						...
						<Card className="p-4 sm:p-6">
							<CardContent className="p-0">
								...
								<p className="text-gray-600 mb-4 text-sm sm:text-base">
									"Периодически пользуемся услугами манипулятора. Всё во время. Надёжный сервис, рекомендую.."
								</p>
								<p className="text-garant-navy font-semibold text-sm sm:text-base">
									Аслан Т.
								</p>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
						<div className="sm:col-span-2 lg:col-span-1">
							...
							<p className="text-gray-300 text-sm sm:text-base">
								Надёжные грузоперевозки Газелями по Крыму: Симферополь, Севастополь, Ялта и другие города
							</p>
						</div>
