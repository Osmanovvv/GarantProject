          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-base sm:text-lg text-gray-700 mb-6 sm:mb-8 leading-relaxed">
                Мы предоставляем качественные услуги грузоперевозок по Крыму и за его пределами. Наша компания гарантирует надежную доставку
                ваших грузов в кратчайшие сроки. Специализируемся на перевозке
                строительных материалов, окон и т.д.
              </p>
            ...
            <div>
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h4 className="text-lg sm:text-xl font-semibold text-garant-navy mb-2">
						Собственный автопарк Газели 3-6м, Манипуляторы
                    </h4>
                    <p className="text-gray-600 text-sm sm:text-base">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm sm:text-base">
                      ...
                      предприятия с полным пакетом документов. Работаем с НДС.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600">
              Специализированные перевозки по Крыму и за его пределами
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <Card className="text-center p-6 sm:p-8 hover:shadow-lg transition-shadow border-2 hover:border-garant-gold">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 text-sm sm:text-base">
                  Специальные рамы автомобилей обеспечивают безопасную
            ...
            <Card className="text-center p-6 sm:p-8 hover:shadow-lg transition-shadow border-2 hover:border-garant-gold sm:col-span-2 lg:col-span-1">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 text-sm sm:text-base">
                  ...
                  города и по всей территории полуострова и за его пределами
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-gray-300 text-sm sm:text-base">
				 Надежные грузоперевозки Газелями по Крыму и за его пределами
              </p>
            </div>
